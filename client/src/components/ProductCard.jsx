...
const ProductCard = ({ product }) => {
  ...
  // This checks if the current product's ID is in the user's wishlist
  ...
  return (
    product && (
      <div
        ...
        className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-56 max-w-56 w-full relative cursor-pointer"
      >
        {/* --- WISHLIST ICON --- */}
        <div
          onClick={(e) => {
