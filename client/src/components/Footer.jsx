...
const Footer = () => {
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-24 bg-zinc-50 text-gray-400 hover:text-grey-900 ">
      ...
      <p className="py-4 text-center text-sm md:text-base text-gray-900">
        Copyright {new Date().getFullYear()} © Krishna.dev All Right Reserved.
      </p>
    </div>
  );
};
